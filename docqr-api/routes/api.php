...
Route::middleware([AuthMiddleware::class])->group(function () {
    ...
    // Acepta POST y PUT para soportar cargas multipart/form-data desde el frontend.
    ...
    Route::get('/documents/check-code', [DocumentController::class, 'checkCodeExists'])->middleware('throttle:120,1');
