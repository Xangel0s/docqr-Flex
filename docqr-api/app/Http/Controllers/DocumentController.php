        ...
        try {
            ...
            $documents->through(function ($document) {
                ...
                return [
                    ...
                    'emission_date' => $document->emission_date?->format('Y-m-d'),
                    ...
                    'final_pdf_url' => (!empty($document->final_path) && $hasQrId)
    ...
    public function showByQrId(string $qrId): JsonResponse
    {
        try {
            ...
            $document = QrFile::withoutTrashed()->select([
                'id', 'qr_id', 'folder_name', 'emission_date', 'original_filename', 'file_size',
            ...
            $recentDocuments = QrFile::withoutTrashed()->orderBy('created_at', 'desc')
                ...
                ->map(function ($doc) {
                    return [
                        ...
                        'emission_date' => $doc->emission_date?->format('Y-m-d'),
    ...
    public function create(Request $request): JsonResponse
    {
        try {
            $request->validate([
                ...
                'emission_date.required' => 'La fecha de emisión es obligatoria',
                'emission_date.date' => 'La fecha de emisión no es válida',
                'emission_date.before_or_equal' => 'La fecha de emisión no puede ser futura',
            ]);

            $folderName = $request->input('folder_name');
            $emissionDate = $request->input('emission_date');
