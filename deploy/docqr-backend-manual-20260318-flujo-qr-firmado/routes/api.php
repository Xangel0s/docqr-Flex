...
Route::get('/doc/{folderName}', [ViewController::class, 'viewByFolderName']); // /api/doc/IN-N-804-25-CO12
...
Route::middleware([AuthMiddleware::class])->group(function () {
    ...
    Route::match(['post', 'put'], '/embed-pdf', [EmbedController::class, 'embedPdf']);
    ...
    // Rutas de carga masiva de PDFs (Módulo Inyección Masiva)
    Route::get('/bulk', [BulkUploadController::class, 'index']);
    Route::get('/bulk/check-code', [BulkUploadController::class, 'checkCode']);
    Route::post('/bulk/create-row', [BulkUploadController::class, 'createRow']);
    Route::post('/bulk/upload', [BulkUploadController::class, 'bulkUpload']);
    Route::post('/bulk/inject/{qrId}', [BulkUploadController::class, 'injectPdf']);
    Route::put('/bulk/fecha-emision/{qrId}', [BulkUploadController::class, 'updateFechaEmision']);
});
